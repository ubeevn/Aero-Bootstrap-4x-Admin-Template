...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-chart"></i><span>Charts</span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="jquery-knob.html">Jquery Knob</a></li>
                </ul>
            </li>            
